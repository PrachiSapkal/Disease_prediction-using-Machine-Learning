...
def show_login_screen():
    ...
    tk.Button(root, text="Login", font=("Elephant", 20), bg="green", command=login).grid(row=3, column=0, padx=10, pady=20)
    tk.Button(root, text="Go to Register", font=("Elephant", 15), bg="blue", command=show_register_screen).grid(row=3, column=1, pady=10)
...
def show_register_screen():
    ...
    tk.Label(root, text="Name:", font=("Elephant", 20), bg="lightblue").grid(row=0, column=0, padx=10, pady=10)
    tk.Label(root, text="Email:", font=("Elephant", 20), bg="lightblue").grid(row=1, column=0, padx=10, pady=10)
    tk.Label(root, text="Password:", font=("Elephant", 20), bg="lightblue").grid(row=2, column=0, padx=10, pady=10)
    tk.Label(root, text="Phone:", font=("Elephant", 20), bg="lightblue").grid(row=3, column=0, padx=10, pady=10)

    global name_entry, email_entry, password_entry, phone_entry
    name_entry = tk.Entry(root, font=("Elephant", 20), width=30)
    email_entry = tk.Entry(root, font=("Elephant", 20), width=30)
    password_entry = tk.Entry(root, font=("Elephant", 20), show="*", width=30)
    
    vcmd = root.register(validate_phone_input)
    phone_entry = tk.Entry(root, font=("Elephant", 20), width=30, validate="key", validatecommand=(vcmd, "%P"))
    ...
    tk.Button(root, text="Register", font=("Elephant", 20), bg="blue", command=register).grid(row=4, column=1, padx=10, pady=20)
    tk.Button(root, text="Go to Login", font=("Elephant", 15), bg="green", command=show_login_screen).grid(row=5, column=1, pady=10)
